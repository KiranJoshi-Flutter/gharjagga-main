...
class PropertyDetailScreen extends StatefulWidget {
  ...
  final PropertiesModel propertiesDetail;
...
class _PropertyDetailScreenState extends State<PropertyDetailScreen> {
  ...
  init() async {
    // print('GlobalVariables.primary.length = ${GlobalVariables.primary.length}');
  ...
  Future _fetchPropertyDetail() async {
    ...
    for (int a = 0; a < widget.propertiesDetail.gallery!.length; a++) {
      print(widget.propertiesDetail.gallery![a].image);
      ...
      galleries.add(
        widget.propertiesDetail.gallery![a].image,
      );
    }
  ...
  Widget build(BuildContext context) {
    ...
    var offerLists = widget.propertiesDetail.offerType!;
    var neighborhoodLists = widget.propertiesDetail.attributes![4].values!;
    var streetLists = widget.propertiesDetail.attributes![5].values!;
    var cityLists = widget.propertiesDetail.attributes![2].values!;
    ...
    if (neighborhoodLists.length != 0) {
      if (neighborhoodLists.length == 1) {
        neighborhoodLabel = neighborhoodLists[0].name;
      } else if (offerLists.length >= 1) {
        neighborhoodLabel = neighborhoodLists[1].name;
      } else {
        neighborhoodLabel = '';
      }
    } else {
                    ...
                    child: GestureDetector(
                      onTap: (() async {
                        if (!isSaved) {
                          ...
                          firestore.collection("wishlist").add({
                            ...
                            'propertyName': widget.propertiesDetail.name,
                            'propertyImage': widget.propertiesDetail.image != ''
                                ? widget.propertiesDetail.image
                                : 'https://gharjhagga.com/wp-content/uploads/2021/11/no-image.png',
                            'propertyPrice': widget
                                .propertiesDetail.price![0].price
                                .replaceAll('RS', ''),
                            'offerType': widget.offerType,
                            'bathroom': widget.propertiesDetail.attributes![7]
                                        .values!.length ==
                                    0
                                ? '0'
                                : '${widget.propertiesDetail.attributes![7].values![0].value}',
                            'bedroom': widget.propertiesDetail.attributes![6]
                                        .values!.length ==
                                    0
                                ? '0'
                                : '${widget.propertiesDetail.attributes![6].values![0].value}',
                            'propertySize': widget.propertiesDetail
                                        .attributes![8].values!.length ==
                                    0
                                ? '0'
                                : '${widget.propertiesDetail.attributes![8].values![0].value}',
                            'userId': userId,
                          }).then((value) {
                            print('Success');
                            snackBar.close();
                      ...
                      child: Container(
                        ...
                        child: Icon(
                          IconlyBold.bookmark,
                          size: 24.0,
                          color: !isSaved ? Colors.white : kThemeColor,
                        ),
                      ),
                    ),
                    // child: Container(
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'NRs. ${widget.propertiesDetail.price!.first.price.replaceAll('RS', '')}',
                      style: appTextStyle(
                        FontWeight.bold,
                        18.0,
                        kThemeColor,
                    ...
                    Row(
                      children: [
                        widget.propertiesDetail.attributes![6].values!.length !=
                                0
                            ? Expanded(
                                flex: 1,
                                child: Container(
                                  child: Row(
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text(
                                          widget.propertiesDetail.attributes![6]
                                              .values!.first.value
                                              .toString(),
                                          style: appTextStyle(
                                            FontWeight.bold,
                            ...
                            : Container(),
                        widget.propertiesDetail.attributes![7].values!.length !=
                                0
                            ? Expanded(
                                flex: 1,
                                child: Container(
                                  child: Row(
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text(
                                          widget.propertiesDetail.attributes![7]
                                              .values!.first.value
                                              .toString(),
                                          style: appTextStyle(
                                            FontWeight.bold,
                            ...
                            : Container(),
                        widget.propertiesDetail.attributes![8].values!.length !=
                                0
                            ? Expanded(
                                flex: 1,
                                child: Container(
                                  child: Row(
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text(
                                          "${widget.propertiesDetail.attributes![8].values!.first.value} ft²",
                                          style: appTextStyle(
                                            FontWeight.bold,
                                            14.0,
                                            kTextColor,
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                widget.propertiesDetail.daysAgo,
                                style: appTextStyleWLS(
                                  FontWeight.normal,
                                  11.0,
                                  Colors.black54,
                    ...
                    Html(
                      data: widget.propertiesDetail.excerpt,
                      shrinkWrap: true,
                    ...
                    widget.propertiesDetail.attributes!.last.values!.length != 0
                        ? Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(
                              ...
                              ListView.builder(
                                ...
                                itemCount: widget.propertiesDetail.attributes!
                                    .last.values!.length,
                                // itemExtent: 80,
                                itemBuilder: (context, index) {
                                  return Container(
                                    ...
                                    child: Text(
                                      widget.propertiesDetail.attributes!.last
                                          .values![index].name,
                                      style: appTextStyleWLS(
                                        FontWeight.bold,
                                        12.0,
