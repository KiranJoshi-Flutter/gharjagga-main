...
class _PropertyTypeScreenState extends State<PropertyTypeScreen> {
  ...
  // _getMoreData() async {
  //   print(
  //       "https://gharjhagga.com/wp-json/wp/v2/estate?_embed&property-type=${widget.propertyTypeId}&page=$currentPage&per_page=20");
  //   final request = await http.get(
  //     Uri.parse(
  //       "https://gharjhagga.com/wp-json/wp/v2/estate?_embed&property-type=${widget.propertyTypeId}&page=$currentPage&per_page=20",
  //     ),
  ...
  //   print("newsList.length = ${propertyList.length}");
  // }
